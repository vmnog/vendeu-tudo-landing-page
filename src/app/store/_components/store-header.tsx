...
import { XMarkIcon, Bars3Icon, MagnifyingGlassIcon, ChevronDownIcon, UserIcon, ShoppingCartIcon } from "@heroicons/react/20/solid"
                          ...
                          >
                            {category.featured.map((item) => (
                              <li key={item.name} className="flex">
                                <a href={pathname + item.href} className="text-gray-500">
                                  {item.name}
                                </a>
                              </li>
                            ))}
            ...
            <div className="space-y-6 border-t border-gray-200 px-4 py-6">
              {navigation.pages.map((page) => (
                <div key={page.name} className="flow-root">
                  <a href={pathname + page.href} className="-m-2 block p-2 font-medium text-gray-900">
                    {page.name}
                  </a>
                </div>
              ))}
                                        ...
                                        <div className="grid grid-cols-2 gap-x-8 gap-y-10">
                                          <div>
                                            ...
                                            >
                                              {category.featured.map((item) => (
                                                <li key={item.name} className="flex">
                                                  <a href={pathname + item.href} className="hover:text-gray-800">
                                                    {item.name}
                                                  </a>
                                                </li>
                                              ))}
